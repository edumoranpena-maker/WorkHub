...
function NewPostSheet({ onSubmit, onClose }) {
  ...
  const STATUS_OPTIONS = [
    { id: "active",      label: "Active",      color: "#1ed99a" },
    { id: "in_progress", label: "In Progress", color: "#f59e0b" },
    { id: "closed",      label: "Closed",      color: "#ff4f6a" },
  ];
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
      ...
      <input ref={mediaRef} type="file" multiple accept="image/*" style={{ display: "none" }} onChange={handleMedia} />
      ...
      <AnimatePresence>
        {showCancel && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            style={{ position: "fixed", inset: 0, zIndex: 2100, background: "rgba(8,8,14,0.9)", backdropFilter: "blur(16px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
